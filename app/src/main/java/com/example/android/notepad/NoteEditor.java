...
public class NoteEditor extends Activity {
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
            ...
            mCursor.moveToFirst();
            //读取颜色数据
            int color_choice = mCursor.getInt(mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_BACK_COLOR));
            ...
            switch (color_choice){
                ...
                case NotePad.Notes.BLUE_COLOR:       //天空蓝
                    mText.setBackgroundColor(Color.rgb(0, 191, 255));
                    break;
                case NotePad.Notes.GREEN_COLOR:       //草原绿
                    mText.setBackgroundColor(Color.rgb(0, 255, 127));
                    break;
